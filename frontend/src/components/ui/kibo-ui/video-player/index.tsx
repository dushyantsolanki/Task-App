...
export const VideoPlayerVolumeRange = ({ className, ...props }: VideoPlayerVolumeRangeProps) => (
  <MediaVolumeRange className={cn('p-1.5', className)} {...props} />
);

export type VideoPlayerPlayButtonProps = ComponentProps<typeof MediaPlayButton>;

export const VideoPlayerPlayButton = ({ className, ...props }: VideoPlayerPlayButtonProps) => (
  <MediaPlayButton className={cn('p-1.5', className)} {...props} />
);
...
export const VideoPlayerSeekBackwardButton = ({
  ...
  <MediaSeekBackwardButton className={cn('p-1.5', className)} {...props} />
);
...
export const VideoPlayerSeekForwardButton = ({
  ...
  <MediaSeekForwardButton className={cn('p-1.5', className)} {...props} />
);

export type VideoPlayerMuteButtonProps = ComponentProps<typeof MediaMuteButton>;

export const VideoPlayerMuteButton = ({ className, ...props }: VideoPlayerMuteButtonProps) => (
  <MediaMuteButton className={cn('p-1.5', className)} {...props} />
);
